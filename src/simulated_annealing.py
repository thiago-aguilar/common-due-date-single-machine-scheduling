...
class SimulatedAnnealing:
    ...
    def __init__(self, task_df, due_date, initial_solution):
        ...
        # Check if sorted any time after due date (we just need to sort it once)
    ...
    def run(self):
        ...
        while not (stop):
            ...
            while (n < minimum_tested) and (perturbations_accepted < minimum_perturbations) :
                ...
                if delta_e <= 0:
                    self.store_solution(new_solution, new_solution_obj, new_tasks_before_due_date, k, n)
    ...
    def calculate_minimum_tested_perturbations(self):
        return 50 * len(self.current_solution)

    def store_solution(self, new_solution, new_solution_obj, tasks_before_due_date, k, n):
    ...
    def calculate_minimum_perturbations(self, current_temperature) -> int:
        ...
        temp_alteration_factor = 3  * len(self.current_solution)
